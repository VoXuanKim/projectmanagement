            ...
            <ul class="menu-list flex-grow-1 mt-3">
                ...
                <li class="collapsed">
                    ...
                    <ul class="sub-menu collapse show" id="client-Components">
                        ...
                        <li><a class="ms-link active" href=""> <span>Client Profile</span></a></li>
                    </ul>
                </li>
                <li class="collapsed">
                            ...
                            <div class="card-body d-flex teacher-fulldeatil">
                                <div class="profile-teacher pe-xl-4 pe-md-2 pe-sm-4 pe-4 text-center w220">
                                    ...
                                    <div class="about-info d-flex align-items-center mt-3 justify-content-center flex-column">
                                        ...
                                        <span class="text-muted small">CLIENT ID : ${client.clientId}</span>
                                    </div>
                                </div>
                                <div class="teacher-info border-start ps-xl-4 ps-md-4 ps-sm-4 ps-4 w-100">
                                    ...
                                    <p class="mt-2 small">${client.description}</p>
